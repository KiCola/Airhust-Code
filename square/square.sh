...
--tab -e 'bash -c "sleep 5; roslaunch mavros px4.launch fcu_url:="/dev/ttyTHS1:921600" gcs_url:="udp://@192.168.50.243"; exec bash"' \
...
--tab -e 'bash -c "sleep 7; roslaunch px4_command square.launch; exec bash"' \
