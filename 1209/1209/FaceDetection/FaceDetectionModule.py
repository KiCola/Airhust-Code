...
class FaceDetector():
    ...
    def findFaces(self,img,draw=True):
        ...
        if self.results.detections:
            for id,detection in enumerate(self.results.detections):
                ...
                cv2.putText(img, f'{str(int(detection.score[0] * 100))}%', (bbox[0], bbox[1] - 20), cv2.FONT_HERSHEY_PLAIN,
                            3, (0, 255, 0), 2)
        return img,bboxs
    ...
    def fancyDraw(self,img,bbox,l=30,t=5,rt=1):
        ...
        # top right x1,y
        cv2.line(img,(x1,y),(x-l,y),(255,0,255),t)
        cv2.line(img,(x1,y),(x,y+l),(255,0,255),t)
        # bottom left x,y1
